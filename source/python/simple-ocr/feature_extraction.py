...
class FeatureExtractor( object ):
    ...
    def extract( self, image, segments, show_steps=False ):
        raise NotImplementedError()

# This pulls the whole rectangular region from the image, shrinks it to (feature_size X feature_size).
# If stretch=false then it maintains the original proportions, filling in the
# new rows/cols with a computed background.
